...
/*
**eg_empleado -> Empleado, RolEmpleado
**reg_cliente -> Cliente, TarjetaCliente
**reg_venta -> Venta, DetalleVenta
**reg_producto -> Producto, CategoriaProducto
**reg_empresa -> Sucursal, ProductoSucursal, Tarjeta
*/

CREATE SCHEMA reg_empleado; 
CREATE SCHEMA reg_cliente; 
CREATE SCHEMA reg_venta; 
CREATE SCHEMA reg_producto;
CREATE SCHEMA reg_empresa;
...
CREATE TABLE Usuario(
	...
	PRIMARY KEY (Usuario),
	FOREIGN KEY (Usuario) REFERENCES reg_empleado.Empleado(DPI)
);
